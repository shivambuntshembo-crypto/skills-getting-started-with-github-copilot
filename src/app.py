...
activities = {
    ...
    "Basketball Club": {
        "description": "Basketball drills, scrimmages, and tournaments",
    ...
    "Painting Studio": {
        "description": "Explore watercolor, acrylic, and mixed media art",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
    ...
    "Math Olympiad": {
        "description": "Problem-solving training for math competitions",
